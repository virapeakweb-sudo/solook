...
<main class="overflow-x-hidden">
    ...
    <section class="bg-primary-900 relative overflow-hidden py-12 md:py-20">
        <div class="absolute inset-0 z-0">
             <img src="<?php echo get_template_directory_uri(); ?>/img/bg-footer.webp" class="w-full h-full object-cover opacity-20 md:opacity-100" alt="Background">
        ...
        <div class="max-w-7xl mx-auto px-4 relative z-10">
            <div class="bg-white/10 backdrop-blur-md rounded-3xl p-6 md:p-12 border border-white/20 shadow-2xl text-center md:text-right flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <a href="tel:۰۲۱-۸۸۳۲۵۶۷۴" class="w-full md:w-auto bg-white text-primary-900 px-8 py-4 rounded-xl font-black text-lg hover:bg-gray-50 transition shadow-lg shadow-black/20 flex items-center justify-center gap-3 group">
