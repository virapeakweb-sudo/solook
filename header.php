    ...
    <div id="mobile-menu-drawer" class="fixed top-0 left-0 bottom-0 w-[85%] max-w-sm bg-white z-[70] shadow-2xl transform -translate-x-full transition-transform duration-300 ease-in-out md:hidden flex flex-col h-full">
        ...
        <div class="p-5 border-b flex justify-between items-center bg-gray-50">
            <div class="flex items-center gap-2">
                <img class="h-8 w-auto" src="https://seirosolok.com/wp-content/uploads/2024/12/Frame-21.png" alt="لوگو">
                <span class="font-bold text-gray-800">سیر و سلوک</span>
            </div>
            ...
            <div class="flex justify-between items-center h-16 md:h-20">
                ...
                <div class="flex-shrink-0 flex items-center gap-2 mx-auto md:mx-0">
                    <a href="<?php echo home_url(); ?>" class="flex items-center gap-2">
                        <img class="h-10 md:h-12 w-auto" src="https://seirosolok.com/wp-content/uploads/2024/12/Frame-21.png" alt="لوگو سیر و سلوک" width="48" height="48">
                        <div class="hidden sm:block">
                            <h1 class="text-lg md:text-xl font-bold text-primary-900">سیر و سلوک</h1>
                            <span class="text-[10px] md:text-xs text-primary-600 font-medium block -mt-1">مجری تورهای زیارتی اقساطی</span>
                        </div>
                    </a>
                </div>
                ...
                <div class="hidden md:flex items-center gap-3">
                    <div class="flex flex-col items-end text-sm ml-2">
                        ...
                        <a href="tel:02112345678" class="font-bold text-lg text-primary-800 dir-ltr tracking-tight">021-12345678</a>
                    </div>
